...
module('Acceptance | symbols loader', function(hooks) {
  ...
  test('symbols are injected to the document', async function(assert) {
    ...
    let expectedSVG = `<svg style="position: absolute; width: 0; height: 0;" width="0" height="0" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
