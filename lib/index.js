...
module.exports = {
  ...
  //     trees.push(this.getHbsStrategyTree());
  //   }
  ...
  treeForPublic(tree) {
    let trees = [this._super.treeForPublic.call(this, tree), ...this.options.createdComponents];
    return new MergeTrees(trees, { overwrite: true });
  },
  ...
  treeForAddon(addonTree) {
    ...
    this.options.createdComponents.push(this._super.treeForAddon.call(this, mergeTreesIfNeeded(trees)))
    return this._super.treeForAddon.call(this, mergeTreesIfNeeded([addonTree]))
  },
